...
<div className="absolute z-20" style={{ top: "15%", left: "55%", width: "40%", height: "60%" }}>
  {[...Array(4)].map((_, i) => (
    ...
    />
      ...
      {/* Gradient Overlay */}
      <div className="absolute inset-y-0 left-0 w-2/3 bg-gradient-to-r from-black/90 to-transparent z-10"></div>
      ...
      >
        <div className="ml-5">
          ...
          <h1 className="text-5xl font-bold mb-4 text-white/87 drop-shadow-[0_0_6px_rgba(192,132,252,0.4)]">Vaishnavi</h1>
          <p className="text-lg max-w-md text-gray-300/80 font-medium">
  ...
  >
    <FaLinkedin className="transition-all duration-300 hover:text-blue-400 hover:drop-shadow-[0_0_10px_#2563eb]" />
          ...
          <Link to="/about"><h4 className="mt-6 font-medium text-[#636ae8]">Who am I? <span className="text-xl font-medium">↝</span> </h4></Link>
        </div>
      </motion.div>
    </div>
  );
